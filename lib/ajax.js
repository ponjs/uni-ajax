...
import { originURL, merge, isCallback } from './utils';
...
class UniAjax {
  constructor(params = {}) {
    ...
    ['GET', 'POST', 'PUT', 'DELETE'].forEach(method => {
      this.request[method.toLowerCase()] = (url = '', data = {}, options = {}) =>
        this.request(...(typeof url === 'string' ? [url, data, { ...options, method }] : [url]));
    });
  }
